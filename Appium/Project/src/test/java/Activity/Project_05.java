...
public class Project_05 {
	...
	public void testSearchAppium() {
		...
		driver.findElement(MobileBy.AndroidUIAutomator("new UiScrollable(new UiSelector().scrollable(true)).scrollIntoView(new UiSelector().textContains(\"Login Form\"))")).click();
	...
	private void sendinput(String Username, String Password) {
		...
		String text = driver.findElement(MobileBy.xpath(".//android.view.View[contains(@resource-id,\"action-confirmation\")]")).getText();
